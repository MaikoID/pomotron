...
public class PomodoroFactory implements IPomodoroCreator{
	...
	public static Duration WorkingTime = new Duration(25*60*1000);

	public static Duration LongBreakTime = new Duration(15*60*1000);

	public static Duration ShortBreakTime = new Duration(5*60*1000);
